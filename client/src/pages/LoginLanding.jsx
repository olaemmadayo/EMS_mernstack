  ...
  const portalOptions = [
    {
      ...
      title: "Admin Portal",
      description:
        "Manage Employee Records, Dpartment, Payroll, and system configuration.",
      icon: ShieldIcon,
    },
    {
      to: "/login/employee",
        ...
        <div className="w-full max-w-md animate-fade-in relative z-10">
          ...
          <div className="mb-10 text-center md:text-left">
            ...
            <p className=" text-slate-500">
              Please select your portal to login into your account
            </p>
          </div>
          {/* Portal List */}
          ...
          <div className="mt-8 text-center">
            <p className="text-slate-500 text-sm">
              © {new Date().getFullYear()}. Olaemmadayo All rights reserved.
            </p>
          </div>
        </div>
      </div>
